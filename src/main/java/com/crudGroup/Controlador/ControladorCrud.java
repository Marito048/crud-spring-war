...
public class ControladorCrud {
    ...
    public String crear(@Validated Usuario usuario, BindingResult bindingresult, ModelMap mp) {
...
public String actualizar(@Validated Usuario usuario, BindingResult bindingResult, ModelMap mp){
    if(bindingResult.hasErrors()){
        mp.put("usuarios", usuarioCrud.findAll());
    return "/home/lista";
    }
